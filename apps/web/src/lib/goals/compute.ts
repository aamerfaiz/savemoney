/**
 * Pure goals computation (Phase 3.5.4) — the sorting/projection/totals logic
 * that used to live in getGoalsData(), unchanged, now taking already-
 ...
 * run since only the browser (vault unlocked) can decrypt goal amounts. See
 * docs/e2ee-path-b-plan.md "Architecture shift" and src/lib/budgets/compute.ts
