/**
 * Direct port of apps/web/src/lib/transactions/compute.ts — pure,
 * framework-free, byte-for-byte the same flatten/sort/summarize logic.
 * (Not moved into packages/finance-engine because it depends on
 * ./types.ts's TransactionKind/Transaction/etc., which — like
 * packages/schemas generally — stays deferred; see
 * docs/mobile-build-phase-plan.md §5 step 1.)
 */
