...
/** Direct port of apps/web/src/lib/goals/types.ts. */
...
export const goalInputSchema = z.object({
  ...
  targetAmount: z.coerce.number().positive("Target must be greater than zero").max(1_000_000_000),
  ...
  monthlyContribution: z.coerce.number().min(0).max(1_000_000_000).optional().nullable(),
});
