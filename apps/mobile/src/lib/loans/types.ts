...
/** Direct port of apps/web/src/lib/loans/types.ts. */
...
export const LOAN_TYPES = ["home", "car", "personal", "education", "credit_card", "other"] as const;
...
export const loanInputSchema = z.object({
  ...
  interestRate: z.coerce.number().min(0, "Rate can't be negative").max(100, "That rate looks too high"),
